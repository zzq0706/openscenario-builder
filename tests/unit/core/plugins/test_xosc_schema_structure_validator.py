...
class TestXoscSchemaStructureValidator:
    ...
    def test_validate_known_element(self):
        ...
        elem_def = ElementDefinition(name="TestElement", attributes=[], children=[])
        schema_info = SchemaInfo(
    ...
    def test_validate_invalid_child_element(self):
        ...
        parent_def = ElementDefinition(
            name="Parent", attributes=[], children=["ValidChild"]
        )
        schema_info = SchemaInfo(
            elements={
                "Parent": parent_def,
    ...
    def test_validate_valid_child_element(self):
        ...
        child_def = ElementDefinition(name="ValidChild", attributes=[], children=[])
        schema_info = SchemaInfo(
            elements={"Parent": parent_def, "ValidChild": child_def},
            groups={},
            root_elements=[],
            element_hierarchy={},
            simple_type_definitions={},
    ...
    def test_validate_with_group_reference(self):
        ...
        schema_info = SchemaInfo(
            elements={"Parent": parent_def, "ChildA": child_def},
