...
from openscenario_builder.core.schema.parser import SchemaInfo, ElementDefinition, AttributeDefinition
...
class TestXoscScenarioValidatorPlugin:
    ...
    def test_plugin_metadata(self):
        ...
        assert validator.metadata.version == "3.1.0"
    ...
    def test_orchestrates_all_validators(self):
        ...
        schema_info = SchemaInfo(
            elements={
                "OpenSCENARIO": ElementDefinition("OpenSCENARIO", [], [])
            },
            groups={},
            root_elements=[],
            element_hierarchy={},
    ...
    def test_uniqueness_validation(self):
        ...
        schema_info = SchemaInfo(
            elements={
                ...
                "Child": ElementDefinition("Child", [
                    AttributeDefinition("name", "string", False)
                ], [])
            },
            groups={},
            root_elements=[],
    ...
    def test_multiple_error_types(self):
        ...
        action = Element("Action", {"speed": "-1", "entityRef": "Missing"})  # Data type + reference errors
        ...
        schema_info = SchemaInfo(
            elements={
                "OpenSCENARIO": ElementDefinition("OpenSCENARIO", [], ["Child", "Action"]),
                "Child": ElementDefinition("Child", [
                    AttributeDefinition("name", "string", False)
                ], []),
                "Action": ElementDefinition("Action", [
    ...
    def test_valid_scenario_no_errors(self):
        ...
        schema_info = SchemaInfo(
            elements={
                ...
                "FileHeader": ElementDefinition("FileHeader", [
