...
class TestChildElementInfo:
    ...
    def test_unbounded_child(self):
        ...
        child_info = ChildElementInfo(
            "ChildElement", min_occur=0, max_occur="unbounded"
        )
...
class TestElementDefinition:
    ...
    def test_create_element_definition(self):
        ...
        element_def = ElementDefinition(
            name="TestElement", attributes=[attr1], children=["Child1", "Child2"]
        )
    ...
    def test_abstract_element(self):
        ...
        element_def = ElementDefinition(
            name="AbstractElement", attributes=[], children=[], is_abstract=True
        )
    ...
    def test_root_element(self):
        ...
        element_def = ElementDefinition(
            name="RootElement", attributes=[], children=[], is_root=True
        )
    ...
    def test_element_with_content_model_type(self):
        ...
        element_def = ElementDefinition(
            name="TestElement", attributes=[], children=[], content_model_type="choice"
        )
    ...
    def test_element_setters(self):
        ...
        element_def = ElementDefinition(name="TestElement", attributes=[], children=[])
...
class TestGroupDefinition:
    ...
    def test_create_group_definition(self):
        ...
        group_def = GroupDefinition(name="TestGroup", children=["Element1", "Element2"])
    ...
    def test_choice_group(self):
        ...
        group_def = GroupDefinition(
            name="ChoiceGroup", children=["Option1", "Option2"], is_choice=True
        )
    ...
    def test_sequence_group(self):
        ...
        group_def = GroupDefinition(
            name="SequenceGroup", children=["Element1", "Element2"], is_sequence=True
        )
    ...
    def test_all_group(self):
        ...
        group_def = GroupDefinition(
            name="AllGroup", children=["Element1", "Element2"], is_all=True
        )
...
class TestSchemaInfo:
    ...
    def test_create_schema_info(self):
        ...
        assert schema_info.simple_type_definitions == {
...
class TestXSDParser:
    ...
    def test_parse_openscenario_schema_function(self, schema_path):
        ...
        assert isinstance(schema_info, ISchemaInfo)
        assert (
            "OpenSCENARIO" in schema_info.elements
            or "FileHeader" in schema_info.elements
        )
